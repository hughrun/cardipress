...
<!-- The above creates a new loop for the HEAD to get the info for this post. -->
  <!-- combine FB and twitter meta where we can -->
  <!-- twitter -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:site" content="@newcardigan" />
  <meta name="twitter:title" property="og:title" content="<?php the_title(); ?>" />
  <meta name="twitter:description" property="og:description" content="<?php the_excerpt(); ?>" />
  <meta name="twitter:image" property="og:image" content="<?php the_post_thumbnail_url(); ?>" />
